...
const Products2Mobile = async () => {
	...
	return <div className='md:hidden'>
		<div className='bg-white rounded-2xl py-16 px-6 space-y-12'>
			...
			<p className='p1-l text-neutral-dark max-w-[17.5rem]'>На сайте вы сможете узнать больше о нашем производственном
			...
			<div className='flex items-center space-x-2'>
				...
				<p className='p3 text-neutral-dark'>Прокрутите вниз, чтобы узнать больше</p>
			</div>
		</div>
		<div className='grid grid-rows-3 grid-cols-2 gap-2 mt-5'>
