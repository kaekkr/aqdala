			...
			<div className='space-y-4'>
				...
				<div>
					<p className='p2-m text-neutral-dark max-w-2xl mx-auto'>
						Ак-Дала Агро – это не только высококачественная продукция, но и
						вклад в развитие региона и поддержку местных жителей.
					</p>
					<p className='p2-m text-neutral-dark max-w-md mx-auto'>
						Мы стремимся к постоянному росту и улучшению, чтобы предложить вам
						лучшее куриное мясо под брендом Аршалы Кус.
					</p>
				</div>
			</div>
