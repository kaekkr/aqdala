...
const HeroMobile = () => {
    return <div className='md:hidden bg-white rounded-2xl flex flex-col px-5 py-3'>
        <h2 className='max-w-xl'>Откройте для себя мир
            <span className='text-orange-500'> свежего и качественного
				куриного мяса!</span>
        </h2>
        <p className='p2-m text-neutral-dark max-w-[18rem]'>
