...
const AboutUsMobile = () => {
    return <div className='md:hidden max-w-full flex flex-col space-y-5'>
        <div className='space-y-2'>
            <p className='p3 bg-orange-100 inline rounded-2xl px-2 py-1'>Коротко о нас</p>
            <h2 className='max-w-3xl'>Компания Ак-Дала Агро – один из
                ведущих производителей <span className='text-orange-500'>куриного
				мяса в Казахстане.</span>
            </h2>
        </div>
        <p className='p1-l text-neutral-dark max-w-[21rem]'>Мы гордимся тем, что предлагаем нашим клиентам широкий
            ассортимент
            высококачественной
