	...
	return <div className='hidden lg:flex justify-between max-w-full mt-32'>
		<div className='space-y-6'>
			<div>
				...
				<h1 className='max-w-2xl'>Компания Ак-Дала Агро – один из
					ведущих производителей <span className='text-orange-500'>куриного
				мяса в Казахстане.</span>
				</h1>
			</div>
			<p className='p1-l text-neutral-dark max-w-xl'>Мы гордимся тем, что предлагаем нашим клиентам широкий
				ассортимент
				высококачественной
				продукции под брендом Аршалы Кус</p>
			<Link href='/about-us' className='inline-flex items-center bg-white rounded-full px-4 py-[17px] space-x-2'>
