const AboutUsHero = () => {
	return <div className='bg-white text-center rounded-3xl p-5'>
		<p className='p3 bg-orange-100 inline rounded-2xl px-2 py-1 mx-auto'>Немножко о нас</p>
		<h1 className='max-w-[47rem] mx-auto'>
				<span className='text-orange-500'>Компания Ак-Дала Агро была
				основана в 2015 году </span>
			и находится всего
			в 30 километрах от столицы Казахстана</h1>
		<p className='p2-m text-neutral-dark max-w-2xl mx-auto'>Ак-Дала Агро – это не только высококачественная продукция,
