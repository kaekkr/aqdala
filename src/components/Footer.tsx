...
const Footer = () => {
    return <footer
        className='bg-white rounded-2xl flex flex-col md:items-center md:text-center md:mx-5 my-2 p-6 space-y-5'>
        <Image src='/logo.svg' alt='logo' width={238} height={114}/>
        <div className='space-y-0'>
            <p className='p3 text-neutral-dark'>Адрес</p>
            <p className='p2-m max-w-[21rem]'>Акмолинская область, Аршалынский район,
